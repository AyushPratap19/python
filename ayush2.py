...
detector = dlib.get_frontal_face_detector("/Users/ayushpratapsingh/Desktop/ ayush.py/shape_predictor_68_face_landmarks.dat.bz2")
predictor = dlib.shape_predictor(cv2.data.haarcascades + 'haarcascade_frontalface_default.xml')

# Start video capture from the default camera (device camera)
...
while True:
    ...
    # Display the frame with blinking information
